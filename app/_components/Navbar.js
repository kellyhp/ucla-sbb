    ...
    <div className="navbar bg-white shadow-sm h-fit relative z-50">
        ...
        <div className="dropdown">
          ...
          {isDropdownOpen && (
            ...
            >
              ...
              <li>
                <Link href="/events" onClick={() => setDropdownOpen(false)}>
                  Events
                </Link>
              </li>
              <li>
                <Link href="/officers" onClick={() => setDropdownOpen(false)}>
                  Officers
                </Link>
              </li>
              <li>
                <Link href="/gallery" onClick={() => setDropdownOpen(false)}>
                  Gallery
                </Link>
              </li>
              <li>
                ...
                <ul className="p-2 bg-white z-50">
                  <li>
                    <a>8 Hour Infectious Disease Certification</a>
                  </li>
                  <li>
                    <a>X-Ray Certification</a>
                  </li>
                  <li>
                    <a>SNDA Conferences</a>
                  </li>
                  <li>
                    <a>Workshops</a>
                  </li>
      ...
      <div className="navbar-center hidden lg:flex justify-center items-center overflow-visible">
        <ul className="menu menu-horizontal px-1 flex justify-center items-center z-50">
          ...
          <li>
            <Link href="/requirements" className="btn rounded-full text-white">
              Requirements
            </Link>
          </li>
        </ul>
